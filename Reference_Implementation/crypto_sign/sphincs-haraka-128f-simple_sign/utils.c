 ...
 */
void treehash_wots(unsigned char root[SPX_N], unsigned char auth_path[SPX_TREE_HEIGHT * SPX_N],
              const unsigned char sk_seed[2*SPX_N], const unsigned char pub_seed[SPX_N],
