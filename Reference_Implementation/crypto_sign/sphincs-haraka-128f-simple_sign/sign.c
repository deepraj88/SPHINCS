                             ...
                             const unsigned char *seed)
{
    ...
    treehash_wots(sk + 3*SPX_N, auth_path, sk, sk + 2*SPX_N, 0, 0, SPX_TREE_HEIGHT,
              top_tree_addr);
...
//    set_tree_addr(wots_addr, tree);
    wots_addr[1] = 0;
    wots_addr[2] = (uint32_t) (tree >> 32);
    wots_addr[3] = (uint32_t) tree;
//    set_keypair_addr(wots_addr, idx_leaf);
    wots_addr[5] = idx_leaf;
...
//        set_tree_addr(tree_addr, tree);
        tree_addr[1] = 0;
        tree_addr[2] = (uint32_t) (tree >> 32);
        tree_addr[3] = (uint32_t) tree;
...
//        set_keypair_addr(wots_addr, idx_leaf);
        ...
        treehash_wots(root, sig, sk_seed, pub_seed, idx_leaf, 0,
