...
//               uint32_t addr[8])
void wots_sign(unsigned char sig[SPX_WOTS_BYTES], const unsigned char msg[SPX_N],
               const unsigned char sk_seed[SPX_N], const unsigned char pub_seed[SPX_N],
               uint32_t addr[8])
{
