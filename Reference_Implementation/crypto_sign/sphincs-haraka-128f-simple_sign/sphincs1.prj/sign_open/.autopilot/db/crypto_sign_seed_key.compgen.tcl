...
set ID 129
set hasByteEnable 0
set MemName crypto_sign_seed_mb6
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename rc_sseed \
    op interface \
    ports { rc_sseed_address0 { O 10 vector } rc_sseed_ce0 { O 1 bit } rc_sseed_we0 { O 1 bit } rc_sseed_d0 { O 8 vector } rc_sseed_q0 { I 8 vector } } \
} "
} else {
