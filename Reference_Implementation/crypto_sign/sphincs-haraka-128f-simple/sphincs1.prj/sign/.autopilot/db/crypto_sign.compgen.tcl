...
set ID 88
set hasByteEnable 0
set MemName crypto_sign_s_inc_1
set CoreName ap_simcore_mem
set PortList { 2 0 }
set DataWd 8
set AddrRange 65
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename sm \
    op interface \
    ports { sm_address0 { O 15 vector } sm_ce0 { O 1 bit } sm_we0 { O 1 bit } sm_d0 { O 8 vector } sm_q0 { I 8 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename sk \
    op interface \
    ports { sk_address0 { O 6 vector } sk_ce0 { O 1 bit } sk_q0 { I 8 vector } } \
} "
} else {
