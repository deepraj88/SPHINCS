...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename s_inc \
    op interface \
    ports { s_inc_address0 { O 7 vector } s_inc_ce0 { O 1 bit } s_inc_we0 { O 1 bit } s_inc_d0 { O 8 vector } s_inc_q0 { I 8 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 's_inc'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename m \
    op interface \
    ports { m_address0 { O 15 vector } m_ce0 { O 1 bit } m_q0 { I 8 vector } } \
} "
} else {
