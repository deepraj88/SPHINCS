...
set ID 47
set hasByteEnable 0
set MemName hash_message_s_inc
set CoreName ap_simcore_mem
set PortList { 2 0 }
set DataWd 8
set AddrRange 65
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename digest \
    op interface \
    ports { digest_address0 { O 6 vector } digest_ce0 { O 1 bit } digest_we0 { O 1 bit } digest_d0 { O 8 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename R \
    op interface \
    ports { R_address0 { O 15 vector } R_ce0 { O 1 bit } R_q0 { I 8 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename pk \
    op interface \
    ports { pk_address0 { O 5 vector } pk_ce0 { O 1 bit } pk_q0 { I 8 vector } } \
} "
} else {
