...
set C_modelArgList {
	{ out_r int 8 regular {array 1224 { 0 3 } 0 1 }  }
...
set Spec2ImplPortList { 
	out_r { ap_memory {  { out_r_address0 mem_address 1 11 }  { out_r_ce0 mem_ce 1 1 }  { out_r_we0 mem_we 1 1 }  { out_r_d0 mem_din 1 8 } } }
...
set RtlHierarchyInfo {[
	...
	{"ID" : "9", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_haraka256_sk_fu_163.grp_unpacklo32_290_fu_211", "Parent" : "3", "Child" : ["10"],
		"CDFG" : "unpacklo32_290",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"Port" : [
			{"Name" : "t", "Type" : "Memory", "Direction" : "O"},
			{"Name" : "b", "Type" : "Memory", "Direction" : "I"}]},
	{"ID" : "10", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.grp_haraka256_sk_fu_163.grp_unpacklo32_290_fu_211.tmp_U", "Parent" : "9"},
