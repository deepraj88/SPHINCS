...
set ID 109
set hasByteEnable 0
set MemName fors_pk_from_sig_hbi
...
set ID 110
set hasByteEnable 0
set MemName fors_pk_from_sig_ibs
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 8
set AddrRange 792
...
set ID 111
set hasByteEnable 0
set MemName fors_pk_from_sig_jbC
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 8
set AddrRange 24
...
set ID 112
set hasByteEnable 0
set MemName fors_pk_from_sig_kbM
set CoreName ap_simcore_mem
set PortList { 2 0 }
set DataWd 32
set AddrRange 8
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename pk \
    op interface \
    ports { pk_address0 { O 5 vector } pk_ce0 { O 1 bit } pk_we0 { O 1 bit } pk_d0 { O 8 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename sig \
    op interface \
    ports { sig_address0 { O 16 vector } sig_ce0 { O 1 bit } sig_q0 { I 8 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename fors_addr \
    op interface \
    ports { fors_addr_address0 { O 3 vector } fors_addr_ce0 { O 1 bit } fors_addr_q0 { I 32 vector } fors_addr_address1 { O 3 vector } fors_addr_ce1 { O 1 bit } fors_addr_q1 { I 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'fors_addr'"
}
}
