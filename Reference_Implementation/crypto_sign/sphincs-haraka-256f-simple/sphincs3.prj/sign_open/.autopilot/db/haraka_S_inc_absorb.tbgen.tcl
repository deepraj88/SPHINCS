...
set C_modelArgList {
	...
	{ m int 8 regular {array 52516 { 1 3 } 1 1 }  }
	{ m_offset int 18 regular  }
	{ mlen int 64 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "s_inc", "interface" : "memory", "bitwidth" : 8, "direction" : "READWRITE"} , 
 	...
 	{ "Name" : "m_offset", "interface" : "wire", "bitwidth" : 18, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ m_address0 sc_out sc_lv 16 signal 1 } 
	{ m_ce0 sc_out sc_logic 1 signal 1 } 
	{ m_q0 sc_in sc_lv 8 signal 1 } 
	{ m_offset sc_in sc_lv 18 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "m_offset", "direction": "in", "datatype": "sc_lv", "bitwidth":18, "type": "signal", "bundle":{"name": "m_offset", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	m { ap_memory {  { m_address0 mem_address 1 16 }  { m_ce0 mem_ce 1 1 }  { m_q0 mem_dout 0 8 } } }
	m_offset { ap_none {  { m_offset in_data 0 18 } } }
