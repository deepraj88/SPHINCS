...
set C_modelArgList {
	{ out_r int 8 regular {array 2144 { 0 3 } 0 1 }  }
	{ out_offset int 12 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "out_r", "interface" : "memory", "bitwidth" : 8, "direction" : "WRITEONLY"} , 
 	{ "Name" : "out_offset", "interface" : "wire", "bitwidth" : 12, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ out_offset sc_in sc_lv 12 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "out_offset", "direction": "in", "datatype": "sc_lv", "bitwidth":12, "type": "signal", "bundle":{"name": "out_offset", "role": "default" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1754", "Max" : "1754"}
	, {"Name" : "Interval", "Min" : "1754", "Max" : "1754"}
]}
...
set Spec2ImplPortList { 
	out_r { ap_memory {  { out_r_address0 mem_address 1 12 }  { out_r_ce0 mem_ce 1 1 }  { out_r_we0 mem_we 1 1 }  { out_r_d0 mem_din 1 8 } } }
	out_offset { ap_none {  { out_offset in_data 0 12 } } }
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "3154", "Max" : "3154"}
	, {"Name" : "Interval", "Min" : "3154", "Max" : "3154"}
]}
