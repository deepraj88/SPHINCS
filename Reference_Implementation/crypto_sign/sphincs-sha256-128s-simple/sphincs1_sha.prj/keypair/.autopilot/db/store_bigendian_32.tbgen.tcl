set moduleName store_bigendian_32
...
set C_modelName {store_bigendian_32}
set C_modelType { void 0 }
set C_modelArgList {
	{ x int 8 regular {array 40 { 0 0 } 0 1 }  }
	{ x_offset int 6 regular  }
	{ u int 32 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "x", "interface" : "memory", "bitwidth" : 8, "direction" : "WRITEONLY"} , 
 	{ "Name" : "x_offset", "interface" : "wire", "bitwidth" : 6, "direction" : "READONLY"} , 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "x_offset", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "x_offset", "role": "default" }} , 
...
set Spec2ImplPortList { 
	x { ap_memory {  { x_address0 mem_address 1 6 }  { x_ce0 mem_ce 1 1 }  { x_we0 mem_we 1 1 }  { x_d0 mem_din 1 8 }  { x_address1 MemPortADDR2 1 6 }  { x_ce1 MemPortCE2 1 1 }  { x_we1 MemPortWE2 1 1 }  { x_d1 MemPortDIN2 1 8 } } }
	x_offset { ap_none {  { x_offset in_data 0 6 } } }
