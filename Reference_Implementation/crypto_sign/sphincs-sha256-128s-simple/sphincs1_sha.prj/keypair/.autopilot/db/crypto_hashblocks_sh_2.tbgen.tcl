set moduleName crypto_hashblocks_sh_2
...
set C_modelName {crypto_hashblocks_sh.2}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3"],
		...
		"Port" : [
			{"Name" : "statebytes", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "3", "SubInstance" : "grp_store_bigendian_32_fu_411", "Port" : "x"},
					{"ID" : "1", "SubInstance" : "grp_load_bigendian_32_1_fu_373", "Port" : "x"}]},
			{"Name" : "in_r", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "grp_load_bigendian_32_4_fu_388", "Port" : "x"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_load_bigendian_32_1_fu_373", "Parent" : "0",
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_load_bigendian_32_4_fu_388", "Parent" : "0",
		...
		"Port" : [
			{"Name" : "x", "Type" : "Memory", "Direction" : "I"},
			{"Name" : "x_offset", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_store_bigendian_32_fu_411", "Parent" : "0",
...
set Spec2ImplPortList { 
	...
	in_r { ap_memory {  { in_r_address0 mem_address 1 6 }  { in_r_ce0 mem_ce 1 1 }  { in_r_q0 mem_dout 0 8 }  { in_r_address1 MemPortADDR2 1 6 }  { in_r_ce1 MemPortCE2 1 1 }  { in_r_q1 MemPortDOUT2 0 8 } } }
}
