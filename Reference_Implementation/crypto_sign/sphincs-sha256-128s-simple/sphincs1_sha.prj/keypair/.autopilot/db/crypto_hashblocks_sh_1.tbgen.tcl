set moduleName crypto_hashblocks_sh_1
...
set C_modelName {crypto_hashblocks_sh.1}
set C_modelType { void 0 }
set C_modelArgList {
	{ statebytes int 8 regular {array 40 { 2 2 } 1 1 }  }
	{ in_r int 8 regular {array 128 { 1 1 } 1 1 }  }
	{ inlen int 9 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "statebytes", "interface" : "memory", "bitwidth" : 8, "direction" : "READWRITE"} , 
 	...
 	{ "Name" : "inlen", "interface" : "wire", "bitwidth" : 9, "direction" : "READONLY"} ]}
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "inlen", "direction": "in", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "inlen", "role": "default" }}  ]}
	...
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3"],
		...
		"Port" : [
			...
			{"Name" : "in_r", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_load_bigendian_32_3_fu_379", "Port" : "x"}]},
			{"Name" : "inlen", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_load_bigendian_32_3_fu_379", "Parent" : "0",
...
set Spec2ImplPortList { 
	...
	inlen { ap_none {  { inlen in_data 0 9 } } }
}
