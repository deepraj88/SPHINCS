...
set C_modelArgList {
	{ in_r int 8 regular {array 38964 { 2 3 } 1 1 }  }
	{ in_offset int 33 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "in_r", "interface" : "memory", "bitwidth" : 8, "direction" : "READWRITE"} , 
 	{ "Name" : "in_offset", "interface" : "wire", "bitwidth" : 33, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ in_offset sc_in sc_lv 33 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "in_offset", "direction": "in", "datatype": "sc_lv", "bitwidth":33, "type": "signal", "bundle":{"name": "in_offset", "role": "default" }} , 
...
set ArgLastReadFirstWriteLatency {
	thash_172 {
		...
		outbuf {Type IO LastRead 11 FirstWrite 8}}
	haraka512_perm {
...
set Spec2ImplPortList { 
	...
	in_offset { ap_none {  { in_offset in_data 0 33 } } }
...
set C_modelType { void 0 }
set C_modelArgList {
	{ out_r int 8 regular {array 38964 { 2 3 } 1 1 }  }
	{ in_offset int 33 regular  }
	{ addr int 32 regular {array 8 { 1 3 } 1 1 }  }
	{ rc int 8 regular {array 640 { 1 3 } 1 1 } {global 0}  }
	{ outbuf int 8 regular {array 32 { 2 3 } 1 1 } {global 2}  }
...
set C_modelArgList {
	...
	{ outbuf int 8 regular {array 32 { 2 0 } 1 1 } {global 2}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "out_r", "interface" : "memory", "bitwidth" : 8, "direction" : "READWRITE"} , 
 	{ "Name" : "in_offset", "interface" : "wire", "bitwidth" : 33, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ outbuf_d0 sc_out sc_lv 8 signal 4 } 
	{ outbuf_q0 sc_in sc_lv 8 signal 4 } 
	{ outbuf_address1 sc_out sc_lv 5 signal 4 } 
	{ outbuf_ce1 sc_out sc_logic 1 signal 4 } 
	{ outbuf_we1 sc_out sc_logic 1 signal 4 } 
	{ outbuf_d1 sc_out sc_lv 8 signal 4 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	{ "name": "ap_rst", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "reset", "bundle":{"name": "ap_rst", "role": "default" }} , 
 	...
 	{ "name": "outbuf_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "outbuf", "role": "d0" }} , 
 	{ "name": "outbuf_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "outbuf", "role": "q0" }} , 
 	{ "name": "outbuf_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "outbuf", "role": "address1" }} , 
 	{ "name": "outbuf_ce1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "outbuf", "role": "ce1" }} , 
 	{ "name": "outbuf_we1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "outbuf", "role": "we1" }} , 
 	{ "name": "outbuf_d1", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "outbuf", "role": "d1" }}  ]}
...
set Spec2ImplPortList { 
	...
	outbuf { ap_memory {  { outbuf_address0 mem_address 1 5 }  { outbuf_ce0 mem_ce 1 1 }  { outbuf_we0 mem_we 1 1 }  { outbuf_d0 mem_din 1 8 }  { outbuf_q0 mem_dout 0 8 }  { outbuf_address1 MemPortADDR2 1 5 }  { outbuf_ce1 MemPortCE2 1 1 }  { outbuf_we1 MemPortWE2 1 1 }  { outbuf_d1 MemPortDIN2 1 8 } } }
}
set moduleName thash_172
set isTaskLevelControl 1
set isCombinational 0
...
set RtlHierarchyInfo {[
	...
	{"ID" : "8", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.grp_haraka512_perm_fu_676.grp_aesenc_fu_168.crypto_sign_mux_42_8_1_1_U1", "Parent" : "6"},
	{"ID" : "9", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.grp_haraka512_perm_fu_676.grp_aesenc_fu_168.crypto_sign_mux_42_8_1_1_U2", "Parent" : "6"},
	{"ID" : "10", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.grp_haraka512_perm_fu_676.grp_aesenc_fu_168.crypto_sign_mux_42_8_1_1_U3", "Parent" : "6"},
	{"ID" : "11", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.grp_haraka512_perm_fu_676.grp_aesenc_fu_168.crypto_sign_mux_42_8_1_1_U4", "Parent" : "6"},
...
set ArgLastReadFirstWriteLatency {
	thash_172 {
		...
		outbuf {Type IO LastRead 23 FirstWrite 7}}
	haraka512_perm {
		out_r {Type O LastRead -1 FirstWrite 4}
		in_r {Type I LastRead 1 FirstWrite -1}
		sbox {Type I LastRead -1 FirstWrite -1}
...
set ArgLastReadFirstWriteLatency {
	thash_172 {
		...
		sbox {Type I LastRead -1 FirstWrite -1}
		rc {Type I LastRead 11 FirstWrite -1}
		outbuf {Type IO LastRead 70 FirstWrite 42}}
	haraka512_perm {
		out_r {Type O LastRead -1 FirstWrite 4}
		in_r {Type I LastRead 1 FirstWrite -1}
		sbox {Type I LastRead -1 FirstWrite -1}
...
set ArgLastReadFirstWriteLatency {
	thash_172 {
		...
		sbox {Type I LastRead -1 FirstWrite -1}
		rc {Type I LastRead 5 FirstWrite -1}
		outbuf {Type IO LastRead 16 FirstWrite 9}}
	haraka512_perm {
		out_r {Type O LastRead -1 FirstWrite 4}
		in_r {Type I LastRead 1 FirstWrite -1}
		sbox {Type I LastRead -1 FirstWrite -1}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "8", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.grp_haraka512_perm_fu_692.grp_aesenc_fu_168.crypto_sign_mux_42_8_1_1_U1", "Parent" : "6"},
	{"ID" : "9", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.grp_haraka512_perm_fu_692.grp_aesenc_fu_168.crypto_sign_mux_42_8_1_1_U2", "Parent" : "6"},
	{"ID" : "10", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.grp_haraka512_perm_fu_692.grp_aesenc_fu_168.crypto_sign_mux_42_8_1_1_U3", "Parent" : "6"},
	{"ID" : "11", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.grp_haraka512_perm_fu_692.grp_aesenc_fu_168.crypto_sign_mux_42_8_1_1_U4", "Parent" : "6"},
...
set ArgLastReadFirstWriteLatency {
	thash_172 {
		...
		outbuf {Type IO LastRead 24 FirstWrite 8}}
	haraka512_perm {
		out_r {Type O LastRead -1 FirstWrite 4}
		in_r {Type I LastRead 1 FirstWrite -1}
		sbox {Type I LastRead -1 FirstWrite -1}
